...
export interface ActivityLogEntry {
  id: string;
  timestamp: string;
  actionType: 'ORDER_CREATED' | 'ORDER_DELETED' | 'STATUS_UPDATE' | 'TEMPLATE_SENT' | 'MANUAL_MESSAGE_SENT' | 'PAYMENT_RECORDED' | 'PROTECTION_LAPSED' | 'AUTO_HEAL' | 'NAVIGATION' | 'API_CALL' | 'API_SUCCESS' | 'USER_ACTION' | 'GPS_VERIFIED' | 'LINK_OPENED' | 'SECURITY_ALERT' | 'WHATSAPP_SENT' | 'TEMPLATE_CREATED' | 'TEMPLATE_EDITED' | 'TEMPLATE_DELETED' | 'LOGIN_SUCCESS' | 'LOGIN_FAILED';
  details: string;
  metadata?: any;
}
